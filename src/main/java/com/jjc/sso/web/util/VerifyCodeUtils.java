...
//		 添加噪点
		...
		for (int i = 0; i < verifySize; i++) {
			...
			g2.drawChars(chars, i, 1, ((w - 30) / verifySize) * i + w / 8, h / 2
					+ fontSize / 2-5);
		}
	...
	private static Color getFontColor(int i){
		Color[] colorSpaces = new Color[] {new Color(254,37,25),new Color(40,182,238),new Color(253,162,27),new Color(82,215,149)};
