/**
 * Created by caoziwen on 2017/2/20.
 */
/*****************************************************************

 jQuery Validate扩展验证方法  (ziwen)
 *****************************************************************/
$(function(){
    // 判断整数value是否等于0
    ...
    jQuery.validator.addMethod("isNewe", function(value, element) {
    return this.optional(element) || /^[a-zA-Z0-9\u4e00-\u9fa5-\_]|[\uFE30-\uFFA0]+$/.test(value);
    }, "只能包含中文、英文、数字和字符");
    // 身份证号码验证
    ...
    jQuery.validator.addMethod("stringCheck", function(value, element) {
        return this.optional(element) || /^[a-zA-Z0-9\u4e00-\u9fa5-_-\u\(\)]+$/.test(value);
    }, "只能包含中文、英文、数字、下划线等字符");
    // 邮箱
    jQuery.validator.addMethod("isEmails", function(value, element) {
        var zip = /^[a-zA-Z0-9_-]+@[a-zA-Z0-9_-]+(\.[a-zA-Z0-9_-]+)+$/;
        return this.optional(element) || (zip.test(value));
    }, "请正确填写您的邮箱");
    // 匹配english
    jQuery.validator.addMethod("isEnglish", function(value, element) {
